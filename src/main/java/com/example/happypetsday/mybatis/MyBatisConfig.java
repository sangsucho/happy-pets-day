package com.example.happypetsday.mybatis;
...
그 중 하나가 @Configuration 이다.
특별한 기능이 있는 것이 아니라 빈의 사용 목적을 구분짓기 위해 이름이 나뉘어져 있디.
@Configuration 는 설정을 위한 빈이라고 알려주고 등록하는 것이다.
 */
...
public class MyBatisConfig {
    ...
    public HikariConfig hikariConfig(){
        ...
        // new HikariConfig()롤 객체를 생성했는데 이 객체의 필드에 설정값을 저장하기 위해
    ...
    public DataSource dataSource(){
        ...
        // CP 를 사용하려면 DataSource 객체가 필요하며 DataSource 객체를 만들기 위해서는 DB정보가 필요하다.
